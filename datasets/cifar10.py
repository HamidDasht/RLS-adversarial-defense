...
class CIFAR10Data(object):
    ...
    def __init__(self, path):
        ...
        torchvision.datasets.CIFAR10(root='./cifar10_data',
                                     train=False,
                                     download=True,
                                     transform=transform)

        train_filenames = [
            'cifar-10-batches-py/data_batch_{}'.format(ii + 1) for ii in range(5)]
        eval_filename = 'cifar-10-batches-py/test_batch'
        metadata_filename = 'cifar-10-batches-py/batches.meta'
